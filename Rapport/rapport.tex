...
\lstinputlisting[firstline=48, lastline=48]{../examples/stats_count/statscount.cpp}
...
\lstinputlisting[firstline=64, lastline=69]{../examples/stats_count/statscount.cpp}
La même chose est fait pour la répartition du fichier. On applique un \texttt{close} en fin d'exécution:
\lstinputlisting[firstline=72, lastline=75]{../examples/stats_count/statscount.cpp}
